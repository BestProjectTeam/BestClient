...
container.images.Add(Image("bcicon", "BestClient/bc_icon.png"))
container.images.Add(Image("bcdevicon", "BestClient/bc_dev_icon.png"))
container.images.Add(Image("bcfakeicon", "BestClient/bc_fake_icon.png"))
