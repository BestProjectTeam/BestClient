...
if(TARGET_OS STREQUAL "linux")
  # The bundled Linux FFmpeg is intentionally minimal and does not contain
  # image demuxers/decoders such as GIF. Prefer the complete system FFmpeg
  # when it is available, while retaining the bundled libraries as fallback.
  set(FFMPEG_AVCODEC_HINTS ${PC_AVCODEC_LIBRARY_DIRS} ${HINTS_FFMPEG_LIBDIR})
  set(FFMPEG_AVFORMAT_HINTS ${PC_AVFORMAT_LIBRARY_DIRS} ${HINTS_FFMPEG_LIBDIR})
  set(FFMPEG_AVUTIL_HINTS ${PC_AVUTIL_LIBRARY_DIRS} ${HINTS_FFMPEG_LIBDIR})
  set(FFMPEG_SWSCALE_HINTS ${PC_SWSCALE_LIBRARY_DIRS} ${HINTS_FFMPEG_LIBDIR})
  set(FFMPEG_SWRESAMPLE_HINTS ${PC_SWRESAMPLE_LIBRARY_DIRS} ${HINTS_FFMPEG_LIBDIR})
else()
  set(FFMPEG_AVCODEC_HINTS ${HINTS_FFMPEG_LIBDIR} ${PC_AVCODEC_LIBRARY_DIRS})
  set(FFMPEG_AVFORMAT_HINTS ${HINTS_FFMPEG_LIBDIR} ${PC_AVFORMAT_LIBRARY_DIRS})
  set(FFMPEG_AVUTIL_HINTS ${HINTS_FFMPEG_LIBDIR} ${PC_AVUTIL_LIBRARY_DIRS})
  set(FFMPEG_SWSCALE_HINTS ${HINTS_FFMPEG_LIBDIR} ${PC_SWSCALE_LIBRARY_DIRS})
  set(FFMPEG_SWRESAMPLE_HINTS ${HINTS_FFMPEG_LIBDIR} ${PC_SWRESAMPLE_LIBRARY_DIRS})
endif()
find_library(AVCODEC_LIBRARY
  NAMES avcodec.61 avcodec libavcodec
  HINTS ${FFMPEG_AVCODEC_HINTS}
