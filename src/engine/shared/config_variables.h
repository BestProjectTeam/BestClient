...
#endif
MACRO_CONFIG_INT(ClSkinMaxWidth, cl_skin_max_width, 1024, 128, 8192, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Maximum skin texture width in pixels (larger skins are downscaled to reduce VRAM usage)") // bestclient
