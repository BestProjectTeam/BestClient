...
MACRO_CONFIG_INT(BcFastInputGammaInput, bc_fast_input_gamma_input, 0, 0, 1200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Fast input amount for gamma input mode in 0.01 ticks")
