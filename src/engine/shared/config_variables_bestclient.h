...
MACRO_CONFIG_INT(BcBestInputInterpolation, bc_best_input_interpolation, 1, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Best input interpolation mode (0 = none, 1 = linear, 2 = cubic, 3 = smooth)")
