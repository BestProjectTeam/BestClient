...
#include <game/client/components/bestclient/ego_tiles_prediction.h> // bestclient
...
void CCharacter::DDRacePostCoreTick()
{
	...
	// bestclient
	if(GameWorld()->m_pEgoTilesPrediction)
		GameWorld()->m_pEgoTilesPrediction->HandleCharacter(this);
	// bestclient
