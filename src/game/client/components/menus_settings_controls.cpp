...
void CMenusSettingsControls::OnInterfacesInit(CGameClient *pClient)
{
	...
	m_vBindOptions = {
		...
		{EBindOptionGroup::BEST_CLIENT, Localizable("Decline swap"), "bc_swap_decline"},
		{EBindOptionGroup::BEST_CLIENT, Localizable("Next swap"), "bc_swap_next"},
		{EBindOptionGroup::BEST_CLIENT, Localizable("Previous swap"), "bc_swap_prev"},
