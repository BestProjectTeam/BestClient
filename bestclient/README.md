[![DDraceNetwork](docs/assets/BestClient_Logo_Horizontal.svg)](https://BestClient.app) 

[![Build status](https://github.com/BestClient/BestClient/workflows/Build/badge.svg)](https://github.com/BestClient/BestClient/actions/workflows/build.yaml)
<!-- [![Code coverage](https://github.com/BestClient/BestClient/branch/master/graph/badge.svg)](https://codecov.io/gh/BestClient/BestClient/branch/master) -->
...
[Website](https://BestClient.app)

### Installation

* Download the latest [release](https://github.com/sjrc6/BestClient-ddnet/releases)
* Download a [nightly (dev/unstable) build](https://github.com/sjrc6/BestClient-ddnet/actions/workflows/fast-build.yml?query=branch%3Amaster)
...
BestClient supports the [ChaiScript](https://chaiscript.com/) language for simple tasks
