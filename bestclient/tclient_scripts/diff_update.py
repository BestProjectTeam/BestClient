...
Diff two BestClient release archives to obtain an update description.
...
""", formatter_class=argparse.RawTextHelpFormatter)
	...
	pairs = [
		(f"BestClient-{args.version1}-win64", f"BestClient-{args.version2}-win64"),
		(f"BestClient-{args.version1}-linux_x86_64", f"BestClient-{args.version2}-linux_x86_64")
	]
